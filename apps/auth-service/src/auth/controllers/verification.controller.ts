...
import { VerifyEmailRateLimit, ResendVerificationRateLimit } from '@cykruit/rate-limit';

@Controller('auth')
export class VerificationController {
    constructor(private readonly verificationService: VerificationService, private readonly csrfGuard: CsrfGuard,) { }
    ...
    async verifyEmail(
        ...
        const ip = sanitizeIpAddress(req.ip ?? req.socket.remoteAddress ?? 'unknown');
