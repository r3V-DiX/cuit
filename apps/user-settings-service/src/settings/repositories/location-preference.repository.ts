...
export class LocationPreferenceRepository {
    ...
    async findAllByUserId(userId: string): Promise<LocationPreferenceWithLocation[]> {
    ...
    async findOneByUserAndLocation(userId: string, locationId: string): Promise<LocationPreference | null> {
        return this.prisma.locationPreference.findUnique({
            where: { userId_locationId: { userId, locationId } },
        });
    }

    async findOneById(id: string, userId: string): Promise<LocationPreference | null> {
