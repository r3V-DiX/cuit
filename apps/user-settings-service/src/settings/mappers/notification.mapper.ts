...
export function mapEmployerNotificationsToResponse(pref: NotificationPreference) {
    return {
        global: {
            enableInApp: pref.enableInApp,
            enableEmail: pref.enableEmail,
...
export type FlatNotificationFields = Partial<Omit<NotificationPreference, 'id' | 'userId' | 'createdAt' | 'updatedAt'>>;

export function flattenSeekerNotificationDto(dto: Record<string, any>): FlatNotificationFields {
...
export function flattenEmployerNotificationDto(dto: Record<string, any>): FlatNotificationFields {
    return dto as FlatNotificationFields;
}