...
export class SeekerSettingsService {
  ...
  async updateGeneralSettings(userId: string, dto: UpdateSeekerGeneralDto) {
    ...
    if (dto.jobSearchStatus !== undefined)
      data.jobSearchStatus = dto.jobSearchStatus;
    if (dto.willingToRelocate !== undefined)
      data.willingToRelocate = dto.willingToRelocate;
    if (dto.preferredJobTypes !== undefined)
      data.preferredJobTypes = dto.preferredJobTypes;
    if (dto.preferredWorkModes !== undefined)
      data.preferredWorkModes = dto.preferredWorkModes;
