...
export class CTFProfileService {
    ...
    async updateCTFProfile(userId: string, ctfProfileId: string, dto: UpdateCTFProfileDto) {
        ...
        await this.prisma.cTFProfile.update({ where: { id: ctfProfileId }, data: dto });
