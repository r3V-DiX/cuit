...
async function bootstrap() {
    ...
    if (process.env.NODE_ENV !== 'production') {
        const config = new DocumentBuilder()
            .setTitle('Seeker Profile Service')
            .setDescription('The Seeker Profile Service API description')
            .setVersion('1.0')
            .addBearerAuth()
            .build();
