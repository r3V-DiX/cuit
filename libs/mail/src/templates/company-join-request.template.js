...
exports.companyJoinRequestTemplate = void 0;
// libs/mail/src/templates/company-join-request.template.ts
const base_template_1 = require("./base.template");
const companyJoinRequestTemplate = (ownerFirstName, requesterName, requesterEmail, companyName, dashboardUrl) => (0, base_template_1.baseTemplate)(`
  ...
  `);
exports.companyJoinRequestTemplate = companyJoinRequestTemplate;
