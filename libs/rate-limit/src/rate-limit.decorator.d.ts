...
export declare const ForgotPasswordRateLimit: () => (target: any, key: string, descriptor: PropertyDescriptor) => void;
/** 3 resend-verification emails per hour */
export declare const ResendVerificationRateLimit: () => MethodDecorator & ClassDecorator;
/** 10 verify-email attempts per hour */
export declare const VerifyEmailRateLimit: () => MethodDecorator & ClassDecorator;
/** 20 refresh-token calls per minute — apps refresh proactively */
export declare const RefreshTokenRateLimit: () => MethodDecorator & ClassDecorator;
