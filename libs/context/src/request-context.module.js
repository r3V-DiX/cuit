...
exports.RequestContextModule = RequestContextModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [request_context_service_1.RequestContextService, request_context_middleware_1.RequestContextMiddleware],
        exports: [request_context_service_1.RequestContextService, request_context_middleware_1.RequestContextMiddleware],
    })
