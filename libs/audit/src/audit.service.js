...
let AuditService = class AuditService {
     ...
     */
    log(action, status, userId, req, metadata) {
     ...
     */
    async logAsync(action, status, userId, req, metadata) {
     ...
     */
    async getUserAuditLog(userId, page = 1, limit = 20, action) {
    ...
    // ── Private ───────────────────────────────────────────────────
    async writeLog(action, status, userId, req, metadata) {
