...
export declare class AuditService {
     ...
     */
    log(action: AuditAction, status: AuditStatus, userId?: string, req?: AuditRequestContext, metadata?: Record<string, any>): void;
    /**
     ...
     */
    logAsync(action: AuditAction, status: AuditStatus, userId?: string, req?: AuditRequestContext, metadata?: Record<string, any>): Promise<void>;
    /**
     * Paginated query — used by GET /auth/audit-log.
     * Returns only safe fields — never sessionId or raw metadata.
     */
    getUserAuditLog(userId: string, page?: number, limit?: number, action?: AuditAction): Promise<{
        logs: {
            userAgent: string;
            id: string;
            createdAt: Date;
