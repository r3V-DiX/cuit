...
export const SEEKER_NOTIFICATION_FIELDS: (keyof NotificationPreference)[] = [
    ...
    'applicationSubmitted_inApp', 'applicationSubmitted_email',
    'applicationStatus_inApp', 'applicationStatus_email',
    'jobRejection_inApp', 'jobRejection_email',
    'interviewScheduled_inApp', 'interviewScheduled_email',
    'jobAlert_inApp', 'jobAlert_email', 'jobAlert_frequency',
];
...
export const EMPLOYER_NOTIFICATION_FIELDS: (keyof NotificationPreference)[] = [
    'enableInApp', 'enableEmail',
    'newApplicant_inApp', 'newApplicant_email',
    'applicationUpdate_inApp', 'applicationUpdate_email',
    'groupedApplicants_inApp', 'groupedApplicants_email', 'groupedApplicants_frequency',
    'jobExpiryAlert_inApp', 'jobExpiryAlert_email',
    'jobApproval_inApp', 'jobApproval_email',
    'kycApproved_inApp', 'kycApproved_email',
    'kycRejected_inApp', 'kycRejected_email',
    'platformAnnouncement_inApp', 'platformAnnouncement_email',
];
