    ...
    async createPackage(dto: CreatePackageDto) {
        return this.prisma.subscriptionPackage.create({
            data: {
                ...
                jobPostingPeriodDays: dto.jobPostingPeriodDays ?? 30,
                resumeViewEnabled: dto.resumeViewEnabled ?? false,
                canExportApplicants: dto.canExportApplicants ?? false,
                analyticsEnabled: dto.analyticsEnabled ?? false,
                prioritySupportEnabled: dto.prioritySupportEnabled ?? false,
    ...
    async updatePackage(id: string, dto: UpdatePackageDto) {
        return this.prisma.subscriptionPackage.update({
            ...
            data: {
                ...
                ...(dto.jobPostingPeriodDays !== undefined ? { jobPostingPeriodDays: dto.jobPostingPeriodDays } : {}),
                ...(dto.resumeViewEnabled !== undefined ? { resumeViewEnabled: dto.resumeViewEnabled } : {}),
                ...(dto.canExportApplicants !== undefined ? { canExportApplicants: dto.canExportApplicants } : {}),
                ...(dto.analyticsEnabled !== undefined ? { analyticsEnabled: dto.analyticsEnabled } : {}),
                ...(dto.prioritySupportEnabled !== undefined ? { prioritySupportEnabled: dto.prioritySupportEnabled } : {}),
