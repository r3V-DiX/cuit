...
export const companyJoinRequestTemplate = (
  ...
  baseTemplate(
    ...
    <div style="text-align:center;margin-bottom:36px;">
      ...
      <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#1e293b;letter-spacing:-0.3px;">Team join request</h1>
      <p style="margin:0;font-size:14px;color:#64748b;font-family:'Courier New',monospace;letter-spacing:1px;">ACTION REQUIRED</p>
    </div>

    <p style="margin:0 0 24px;color:#475569;font-size:15px;line-height:1.75;text-align:center;">
      Hey <strong style="color:#1e293b;">${ownerFirstName}</strong>, someone from your company domain wants to join the <strong style="color:#1e293b;">${companyName}</strong> team on Cykruit.
    </p>
      ...
      <tr>
        <td style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:18px 22px;">
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td style="padding:6px 0;font-size:13px;font-family:'Courier New',monospace;letter-spacing:0.5px;border-bottom:1px solid #e2e8f0;">
                <span style="color:#94a3b8;">NAME</span>&nbsp;&nbsp;&nbsp;&nbsp;<strong style="color:#1e293b;">${requesterName}</strong>
              </td>
            </tr>
            <tr>
              <td style="padding:6px 0;font-size:13px;font-family:'Courier New',monospace;letter-spacing:0.5px;">
                <span style="color:#94a3b8;">EMAIL</span>&nbsp;&nbsp;&nbsp;<strong style="color:#3b82f6;">${requesterEmail}</strong>
              </td>
            </tr>
          </table>
        </td>
    ...
    <p style="margin:0 0 24px;color:#475569;font-size:14px;line-height:1.75;text-align:center;">
