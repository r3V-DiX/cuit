...
export const passwordResetTemplate = (resetUrl: string): string =>
  baseTemplate(
    ...
    <div style="text-align:center;margin-bottom:36px;">
      ...
      <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#f1f5f9;letter-spacing:-0.3px;">Password reset request</h1>
      <p style="margin:0;font-size:14px;color:#4b5563;font-family:'Courier New',monospace;letter-spacing:1px;">SECURE CREDENTIAL UPDATE</p>
    </div>

    <p style="margin:0 0 24px;color:#9ca3af;font-size:15px;line-height:1.75;text-align:center;">
      We received a request to reset the password for your Cykruit account. Click below to create a new password — this link is valid for <strong style="color:#f1f5f9;">1 hour</strong>.
    </p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:28px 0 0;">
      <tr>
        <td style="background:rgba(245,158,11,0.07);border:1px solid rgba(245,158,11,0.2);border-left:3px solid #f59e0b;border-radius:0 8px 8px 0;padding:14px 16px;">
          <p style="margin:0;font-size:12px;color:#92400e;font-family:'Courier New',monospace;letter-spacing:0.5px;">
