          ...
          <table border="0" cellspacing="0" cellpadding="0" style="margin:0 auto; width: 100%; max-width: 440px; background-color: #ffffff; border: 1px solid ${COLORS.PAPER_BORDER}; border-radius: 10px; padding: 20px;">
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="padding: 6px 0; font-family:${TYPOGRAPHY.FONT_PRIMARY}; font-size:14px; color:${COLORS.MUTED}; border-bottom: 1px solid #f1f5f9;">Job Title</td>
                    <td align="right" style="padding: 6px 0; font-family:${TYPOGRAPHY.FONT_PRIMARY}; font-size:14px; font-weight:700; color:${COLORS.INK}; border-bottom: 1px solid #f1f5f9;">${data.jobTitle}</td>
                  </tr>
                  <tr>
                    ...
                    <td align="right" style="padding: 6px 0; font-family:${TYPOGRAPHY.FONT_PRIMARY}; font-size:14px; font-weight:700; color:${COLORS.INK}; border-bottom: 1px solid #f1f5f9;">${data.companyName}</td>
                  </tr>
                  <tr>
                    <td style="padding: 6px 0; font-family:${TYPOGRAPHY.FONT_PRIMARY}; font-size:14px; color:${COLORS.MUTED};">Type / Mode</td>
                    <td align="right" style="padding: 6px 0; font-family:${TYPOGRAPHY.FONT_PRIMARY}; font-size:14px; font-weight:700; color:${COLORS.BRAND_PRIMARY};">${data.jobType} · ${data.workMode}</td>
                  </tr>
                </table>
              </td>
            </tr>
