...
export const verificationTemplate = (verifyUrl: string): string =>
  baseTemplate(
    ...
    <div style="text-align:center;margin-bottom:36px;">
      ...
      <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#1e293b;letter-spacing:-0.3px;">Verify your email address</h1>
      <p style="margin:0;font-size:14px;color:#64748b;font-family:'Courier New',monospace;letter-spacing:1px;">ACCOUNT ACTIVATION REQUIRED</p>
    </div>

    <p style="margin:0 0 24px;color:#475569;font-size:15px;line-height:1.75;text-align:center;">
      You're one step away from joining the <strong style="color:#1e293b;">cybersecurity job platform</strong> built for the infosec community. Confirm your email to activate your account.
    </p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:28px 0 0;">
      <tr>
        <td style="background:rgba(37,99,235,0.06);border:1px solid rgba(37,99,235,0.15);border-left:3px solid #2563eb;border-radius:0 8px 8px 0;padding:14px 16px;">
          <p style="margin:0;font-size:12px;color:#374151;font-family:'Courier New',monospace;letter-spacing:1px;">
            ⏰ LINK EXPIRES IN <strong style="color:#1e293b;">24 HOURS</strong> &nbsp;|&nbsp; SINGLE USE ONLY
          </p>
        </td>
      </tr>
    </table>
