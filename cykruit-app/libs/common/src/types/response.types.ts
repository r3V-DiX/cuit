// libs/common/types/response.types.ts
...
export function isErrorResponse(response: ApiResponse): response is IErrorResponse {
    return response.success === false;
}

export function hasWarning<T>(response: ApiResponse<T>): response is IWarningResponse<T> {
    return response.success === true && 'warning' in response;
}

export function hasInfo<T>(response: ApiResponse<T>): response is IInfoResponse<T> {
