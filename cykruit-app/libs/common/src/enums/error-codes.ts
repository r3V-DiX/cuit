...
export const ErrorCodeDescriptions: Record<string, string> = {
    [AuthErrorCodes.INVALID_CREDENTIALS]: 'The email or password provided is incorrect',
    [AuthErrorCodes.EMAIL_ALREADY_EXISTS]: 'An account with this email already exists',
    [AuthErrorCodes.EMAIL_NOT_VERIFIED]: 'Please verify your email before logging in',
    ...
    [AuthErrorCodes.ACCOUNT_SUSPENDED]: 'Your account has been suspended. Contact support',
    [UserErrorCodes.USER_NOT_FOUND]: 'User account not found',
    [UserErrorCodes.PROFILE_NOT_FOUND]: 'User profile not found',
    [UserErrorCodes.PROFILE_INCOMPLETE]: 'Please complete your profile to continue',
    [UserErrorCodes.PROFILE_NOT_CREATED]: 'Profile has not been created yet',
    [UploadErrorCodes.FILE_TOO_LARGE]: 'File size exceeds the maximum allowed limit',
    ...
    [JobErrorCodes.COMPANY_NOT_VERIFIED]: 'Your company must be verified to post jobs',
    [ApplicationErrorCodes.APPLICATION_NOT_FOUND]: 'Application not found',
    [ApplicationErrorCodes.ALREADY_APPLIED]: 'You have already applied to this job',
    [ApplicationErrorCodes.JOB_EXPIRED]: 'This job posting has expired',
    [ApplicationErrorCodes.PROFILE_COMPLETION_TOO_LOW]: 'Complete your profile to at least 70% to apply',
    [ApplicationErrorCodes.ALREADY_WITHDRAWN]: 'This application has already been withdrawn',
    [ApplicationErrorCodes.CANNOT_WITHDRAW_REJECTED]: 'Cannot withdraw a rejected application',
    [ApplicationErrorCodes.NOT_YOUR_APPLICATION]: 'This application does not belong to you',
    [ApplicationErrorCodes.NOT_YOUR_JOB]: 'This job does not belong to your company',
    ...
    [ExternalServiceErrorCodes.EMAIL_SEND_FAILED]: 'Failed to send email. Please try again',
    ...
    [VerificationErrorCodes.VERIFICATION_PENDING]: 'You already have a pending verification request',
