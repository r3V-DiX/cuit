...
export class ResponseBuilder {
    ...
    constructor(
        ...
        const includeMetaInProd =
            this.configService.get<string>('INCLUDE_META_IN_PRODUCTION', 'false') === 'true';
        ...
        this.includePath = this.configService.get<string>(
            'INCLUDE_PATH',
    ...
    private buildMeta(path?: string): IResponseMeta | undefined {
        ...
        if (this.includeRequestId && context?.requestId) meta.requestId = context.requestId;
