...
export default function EmployerSettingsPage() {
  ...
  function deleteAccount() {
    openModal({
      ...
      description: "All company data, job listings, and applicant records will be permanently deleted. This cannot be undone.",
                ...
                <Section title="Danger Zone" desc="Permanent actions that cannot be undone.">
                  <div className="flex items-center justify-between p-4 rounded-xl border border-red-100 bg-red-50/50">
                    ...
                    <button onClick={deleteAccount}
                      className="flex items-center gap-1.5 text-xs font-semibold text-red-600 border border-red-200 hover:bg-red-100 px-3 py-2 rounded-xl transition-colors shrink-0 cursor-pointer">
