...
const navItems = [
  ...
  { label: "Messages",      href: "/employer/messages",      icon: MessageSquare, badge: 2 },
  { label: "Company",       href: "/employer/company",       icon: Building2       },
  { label: "Notifications", href: "/employer/notifications", icon: Bell, badge: 3  },
      ...
      <>
        ...
        <div className="flex items-center h-16 border-b border-slate-100 px-4 gap-2.5 overflow-hidden">
          ...
          >
            ...
            <span className="block text-[10px] font-mono text-blue-500 whitespace-nowrap -mt-0.5">
              Employer
            </span>
          </div>
